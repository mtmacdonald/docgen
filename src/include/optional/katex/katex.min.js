!(function (e, t) {
  ...
  return (function () {
    ...
    var E = O,
      ...
      V = function (e) {
        return (
          'string' != typeof e && (e = e.unit), e in L || e in D || 'ex' === e
        );
      },
      P = function (e, t) {
        var r;
    ...
    function ie(e, t, r, n, a, i) {
      (ne[e][a] = { font: t, group: r, replace: n }),
        i && n && (ne[e][n] = ne[e][a]);
    }
    var oe = 'math',
      se = 'text',
      ...
      Ke = {
            ...
            var r = (function (e) {
                ...
                if ('top' === e.positionType) {
                  for (
                    ...
                    var m = e.children[c];
                    h -=
                      'kern' === m.type ? m.size : m.elem.height + m.elem.depth;
                  }
                  l = h;
        ...
        makeOrd: function (e, t, r) {
          ...
          if (l) {
            ...
            if ('boldsymbol' === l) {
              ...
              s
                ? ((u = $e[l].fontName), (p = [l]))
                : ((u = je(l, t.fontWeight, t.fontShape)),
        ...
        staticSvg: function (e, t) {
          var r = Ze[e],
            ...
            l = We(['overlay'], [s], t);
          return (
            (l.height = i), (l.style.height = F(i)), (l.style.width = F(a)), l
          );
        },
        svgData: Ze,
          ...
          gt(
            ...
            function (e, t) {
              var r = yt(t),
                n = yt(e),
                a =
                  r && n ? (e.hasClass('mtight') ? rt[r][n] : tt[r][n]) : null;
      ...
      gt = function e(t, r, n, a, i) {
        ...
        for (var o = 0; o < t.length; o++) {
          ...
          if (l) e(l.children, r, n, null, i);
            ...
            h
              ? (n.node = s)
              : i && s.hasClass('newline') && (n.node = ct(['leftmost'])),
      ...
      for (var i, o = [], s = [], l = 0; l < a.length; l++)
        if (
          ...
          a[l].hasClass('newline') &&
            (s.pop(),
            s.length > 0 && (o.push(kt(s, t)), (s = [])),
            o.push(a[l]));
      s.length > 0 && o.push(kt(s, t)),
        r
          ? (((i = kt(ft(r, t, !0))).classes = ['tag']), o.push(i))
          : n && o.push(n);
    ...
    var Wt = function (e, t) {
      ...
      _t = function (e, t) {
        var r = e.isStretchy
            ? Ft(e.label)
            : new Tt.MathNode('mo', [Bt(e.label, e.mode)]),
      ...
      htmlBuilder: function (e, t) {
        ...
        i.classes.push(o + '-arrow-pad'),
          e.below &&
            ...
            (r = Ke.wrapFragment(wt(e.below, a, t), t)).classes.push(
              o + '-arrow-pad',
            ));
        var s,
          l = Gt(e, t),
    ...
    ot({
      ...
      ot({
        ...
        handler: function (e, t) {
          for (
            var r = e.parser, a = Ut(t[0], 'ordgroup').body, i = '', o = 0;
            o < a.length;
            o++
          ) {
    ...
    var lr = function (e, t, r) {
      ...
      mr = function (e, t, r, n, a, i) {
        var o = (function (e, t, r, n) {
          ...
          s = hr(
            Ke.makeSpan(['delimsizing', 'size' + t], [o], n),
            x.TEXT,
            n,
            i,
          );
      ...
      vr = function (e, t, r, n, a, i) {
        ...
        var V = n.havingBaseStyle(x.TEXT),
          P = Ke.makeVList(
            { positionType: 'bottom', positionData: T, children: B },
            V,
          );
          ...
          return (
            'small' === i.type
              ...
              ? ((c = 1080 * Sr[i.size]),
                (h = (Sr[i.size] + s) / o),
                (l = (Sr[i.size] + s + br) / o),
                ((r = yr('sqrtSize' + i.size, l, c, s, t)).style.minWidth =
                  '1.02em'),
                (n = 1 / o))
              : ((l = e + s + br),
                (h = e + s),
    ...
    var jr = function (e, t) {
        ...
        e.colSeparationType &&
          ...
          (p =
            (t.havingStyle(x.SCRIPT).sizeMultiplier / t.sizeMultiplier) *
            0.2778);
        var d =
        ...
        for (a = 0, N = 0; a < s || N < I.length; ++a, ++N) {
          ...
          if (!(a >= s)) {
            ...
            (a > 0 || e.hskipBeforeAndAfter) &&
              ...
              (((C = Ke.makeSpan(['arraycolsep'], [])).style.width = F(W)),
              R.push(C));
            var _ = [];
            for (r = 0; r < i; ++r) {
              var j = h[r],
    ...
    Dr({
      ...
      props: { numArgs: 1 },
      handler: function (e, t) {
        var r = (Xt(t[0]) ? [t[0]] : Ut(t[0], 'ordgroup').body).map(function (
            e,
          ) {
            var t = Yt(e).text;
      ...
      Dr({
        ...
        handler: function (e, t) {
          ...
          if (
            (a = Wr(e.parser, a, 'script')).body.length > 0 &&
            a.body[0].length > 1
          )
            throw new n('{subarray} can contain only one column');
          return a;
      ...
      nn = function (e, t) {
        ...
        if (
          (e.hasBarLine
            ? (e.barSize
                ? ((c = P(e.barSize, t)),
                  (h = Ke.makeLineSpan('frac-line', t, c)))
          ...
          u - o.depth - (w + 0.5 * c) < p &&
            (u += p - (u - o.depth - (w + 0.5 * c))),
            w - 0.5 * c - (y.height - d) < p &&
              (d += p - (w - 0.5 * c - (y.height - d)));
          var k = -(w - 0.5 * c);
          f = Ke.makeVList(
            {
              positionType: 'individualShift',
    ...
    ot({
      ...
      ot({
        ...
        mathmlBuilder: function (e, t) {
          var r = It(e.body, t);
          return (
            r instanceof zt || (r = new zt('mrow', [r])),
    ...
    ot({
      ...
      handler: function (e, t, r) {
        ...
        if (r[0])
          for (
            var h = Ut(r[0], 'raw').string.split(','), c = 0;
            c < h.length;
            c++
          ) {
            var m = h[c].split('=');
      ...
      ot({
        ...
        htmlBuilder: function (e, t) {
          var r;
          'clap' === e.alignment
            ? ((r = Ke.makeSpan([], [wt(e.body, t)])),
              (r = Ke.makeSpan(['inner'], [r], t)))
    ...
    var mn = function (e, t, r, n, a, i, o) {
      ...
      pn = function (e, t) {
        ...
        var o,
          ...
          h = !1;
        if (
          (s.size === x.DISPLAY.size &&
            a.symbol &&
            !l.contains(un, a.name) &&
            (h = !0),
          a.symbol)
        ) {
    ...
    ot({
      ...
      mathmlBuilder: function (e, t) {
        for (
          var r = qt(e.body, t.withFont('mathrm')), n = !0, a = 0;
          a < r.length;
          a++
        ) {
          var i = r[a];
    ...
    var wn = function (e, t) {
      ...
      return r
        ? 'op' === r.type
          ? r.limits &&
            (t.style.size === x.DISPLAY.size || r.alwaysHandleSupSub)
            ? pn
            : null
          : 'operatorname' === r.type
          ? r.alwaysHandleSupSub &&
            (t.style.size === x.DISPLAY.size || r.limits)
            ? vn
            : null
          : 'accent' === r.type
        ...
        if ((e.sub && i.push(Rt(e.sub, t)), e.sup && i.push(Rt(e.sup, t)), n))
          ...
          a =
            (l &&
              'op' === l.type &&
              l.limits &&
              (t.style === x.DISPLAY || l.alwaysHandleSupSub)) ||
            (l &&
              'operatorname' === l.type &&
    ...
    ot({
      ...
      ot({
        ...
        htmlBuilder: function (e, t) {
          for (
            var r = Nn(e), n = [], a = t.havingStyle(t.style.text()), i = 0;
            i < r.length;
            i++
          ) {
            var o = r[i];
            '~' === o && (o = '\\textasciitilde'),
              n.push(
                Ke.makeSymbol(o, 'Typewriter-Regular', e.mode, a, [
                  'mord',
                  'texttt',
                ]),
              );
    ...
    Pr('\\newcommand', function (e) {
      ...
      Pr('\\show', function (e) {
        var t = e.popToken(),
          r = t.text;
        return (
          console.log(t, e.macros.get(r), qn[r], ae.math[r], ae.text[r]), ''
        );
      }),
      Pr('\\bgroup', '{'),
      Pr('\\egroup', '}'),
            ...
            if ('string' == typeof n) {
              ...
              if (-1 !== n.indexOf('#'))
                for (
                  ...
                  ++a;
              for (
                var o = new Ln(n, this.settings), s = [], l = o.lex();
                'EOF' !== l.text;
      ...
      Jn = (function () {
        ...
        return (
          ...
          (t.parseAtom = function (t) {
            ...
            return r || a
              ? { type: 'supsub', mode: this.mode, base: i, sup: r, sub: a }
              : i;
          }),
