...
!(function (e) {
  ...
  function l(e, r, a, i) {
    ...
    function m() {
      ...
      return (
        k.r > 0 && (E += e.r),
        'continuous' == k.subLanguageMode && (x[k.sL] = e.top),
    ...
    function h(e, r) {
      ...
      if (a) {
        var i = k;
        i.rE || i.eE || (S += r), (M += g());
        do k.cN && (M += '</span>'), (E += k.r), (k = k.parent);
        while (k != a.parent);
        return (
          i.eE && (M += t(r)),
          (S = ''),
    ...
    var S = '',
      E = 0;
    try {
      for (var B, I, L = 0; (k.t.lastIndex = L), (B = k.t.exec(r)), B; )
        (I = h(r.substr(L, B.index - L), B[0])), (L = B.index + I);
      h(r.substr(L));
      for (var C = k; C.parent; C = C.parent) C.cN && (M += '</span>');
      return { r: E, value: M, language: e, top: k };
    } catch (R) {
  ...
  hljs.registerLanguage('bash', function (e) {
    ...
    return {
      ...
      k: {
        ...
        literal: 'true false',
        built_in:
          'break cd continue eval exec exit export getopts hash pwd readonly return shift test times trap umask unset alias bind builtin caller command declare echo enable help let local logout mapfile printf read readarray src type typeset ulimit unalias set shopt autoload bg bindkey bye cap chdir clone comparguments compcall compctl compdescribe compfiles compgroups compquote comptags comptry compvalues dirs disable disown echotc echoti emulate fc fg float functions getcap getln history integer jobs kill limit log noglob popd print pushd pushln rehash sched setcap setopt stat suspend ttyctl unfunction unhash unlimit unsetopt vared wait whence where which zcompile zformat zftp zle zmodload zparseopts zprof zpty zregexparse zsocket zstyle ztcp',
